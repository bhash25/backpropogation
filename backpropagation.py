...
def train_network(layer_sizes, inputs, target_func, learning_rate=0.02, max_iterations=200000, sse_threshold=0.01):
    ...
    for itr in range(max_iterations):
        ...
        for inp in inputs:
            ...
            for layer in range(len(weights)):
                weights[layer] -= learning_rate * np.dot(deltas[layer], a[layer].T)
...
weights, biases, errors, itr = train_network(layer_sizes, inputs, target_func)
